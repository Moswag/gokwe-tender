...
class _ViewTendersClosedState extends State<ViewTendersClosed> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        drawer: AdminDrawer(),
        appBar: new AppBar(
          title: new Text('Finished Tenders'),
          centerTitle: true,
        ),
...
//                    .where('time', isLessThanOrEqualTo: TimeOfDay.now())
                    .snapshots(),
    ...
    ListView getNoteListView() {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          ...
          tender.description = document[positon].data['description'].toString();
          tender.dueDate = document[positon].data['dueDate'].toString() +
              ' ' +
              document[positon].data['dueTime'].toString();
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  trailing: GestureDetector(
                    ...
                    child:
                        Icon(Icons.thumb_up, color: Colors.white, size: 25.0),
                    onTap: () {
