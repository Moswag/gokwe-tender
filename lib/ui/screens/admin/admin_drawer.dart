        ...
        child: ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushNamed(RouteConstants.VIEW_ADMINS);
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushNamed(RouteConstants.VIEW_CATEGORIES);
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushNamed(RouteConstants.VIEW_COMPANIES);
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.of(context).pushNamed(RouteConstants.VIEW_TENDERS);
              },
            ),
            new ListTile(
